...
## 시각화 알고리즘
데이터를 다루어 정리하는 과정은 효율적인 그래피컬 테크닉(Graphical Technique, 시각화)을 사용하는 것을 포함합니다. 본문에서는 *특정 프로젝트*를 수행하는데 사용한 시각화 방식에 대하여 설명합니다. 프로젝트는 특성상 일반 공개가 어렵습니다. 읽는 분들의 너른 양해를 구합니다.
### 배치
